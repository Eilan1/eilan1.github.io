...
Open app.html (or run locally — see below).



Tap + Habit and enter a name.



Swipe a habit left when you finish it; swipe right to undo.



Open ⚙ Settings for theme and other toggles.



Use Stats and Insights tabs for charts and today’s message.
...
Enter a name in the prompt and confirm.
...
Delete habit (confirmation depends on settings)
...
App logic (habits, swipe, settings, XP)
...
App styles (themes, toggles, layout)
...
Legacy modules — not loaded by the current app
